...
/**
 * gaParticipant filter form base class.
 *
 * @package    BDS
 * @subpackage filter
 ...
 */
abstract class BasegaParticipantFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ga_participant_filters[%s]');
