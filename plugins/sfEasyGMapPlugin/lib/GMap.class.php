...
class GMap {
    ...
    protected $options = array(
        ...
        'zoom' => null,
        'mapTypeId' => 'google.maps.MapTypeId.ROADMAP', // string The initial Map mapTypeId. Required.
        'disableDefaultUI' => null, // boolean Enables/disables all default UI. May be overridden individually.
        'mapTypeControl' => null, // boolean The initial enabled/disabled state of the Map type control.
        'mapTypeControlOptions' => null, // MapTypeControl options The initial display options for the Map type control.
        'scaleControl' => null, // boolean The initial enabled/disabled state of the scale control.
        'scaleControlOptions' => null, // ScaleControl options The initial display options for the scale control.
        'navigationControl' => null, // boolean The initial enabled/disabled state of the navigation control.
        'navigationControlOptions' => null // NavigationControl options The initial display options for the navigation control.
    );
